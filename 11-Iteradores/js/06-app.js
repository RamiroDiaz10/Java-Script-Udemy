...
carrito.forEach( productos =>  {
    console.log(`Agregaste ${productos.producto}`);
});

// Lo mismo aplica para los maps, la sintaxis es la misma, solo recuerda, el map te crea un nuevo arreglo,
//  si solo deseas 
// recorrer los elementos utiliza el Foreach, si requieres crear un nuevo arreglo, sin duda el map sera mejor...
...
const nuevoArreglo = carrito2.forEach( producto => producto.id );

const nuevoArreglo2 = carrito2.map( producto => producto.id );
